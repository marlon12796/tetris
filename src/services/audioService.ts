...
export class AudioService {
	...
	private static playSound(shouldPlay: boolean, when: number, offset: number, duration: number) {
		if (!shouldPlay) {
			return;
		}
	...
	private static getSource(ctx: AudioContext, buffer: AudioBuffer): AudioBufferSourceNode {
